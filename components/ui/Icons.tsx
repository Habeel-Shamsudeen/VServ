export function CalendarDaysIcon(props:{className:string}) {
    return (
      <svg
        {...props}
  ...
  export function ClipboardListIcon(props:{className:string}) {
    return (
      <svg
        {...props}
        xmlns="http://www.w3.org/2000/svg"
  ...
  export function WrenchIcon(props:{className:string}) {
    return (
      <svg
        {...props}
        xmlns="http://www.w3.org/2000/svg"
  ...
  export function CarIcon(props:{className:string}) {
    return (
      <svg
        {...props}
        xmlns="http://www.w3.org/2000/svg"
